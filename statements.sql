...
-- Tu respuesta aquí
SELECT nombre, apellido, COUNT(lenguaje) FROM usuarios_lenguajes GROUP BY nombre, apellido;
...
-- Tu respuesta aquí
SELECT * FROM usuarios_lenguajes WHERE LENGTH(lenguaje) = (SELECT MAX(LENGTH(lenguaje)) FROM usuarios_lenguajes) AND edad < 30;
...
-- Tu respuesta aquí
SELECT lenguaje FROM usuarios_lenguajes WHERE lenguaje LIKE 'J%' ORDER BY LENGTH(lenguaje) ASC LIMIT 1;
